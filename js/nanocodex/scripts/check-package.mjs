...
const requiredFiles = [
  ...
  "cloudflare/hand-admission.mjs",
  "cloudflare/hand-admission.d.mts",
...
export async function checkPackage(packageRoot = root) {
  ...
  assert.equal(packageJson.exports?.["./cloudflare/hand-admission"]?.import, "./cloudflare/hand-admission.mjs");
  assert.equal(packageJson.exports?.["./cloudflare/hand-admission"]?.types, "./cloudflare/hand-admission.d.mts");
  ...
  assert.equal(packageJson.exports?.["./tools/vite"], undefined);
  assert.equal(packageJson.exports?.["./vite"], undefined);
  assert.equal(packageJson.exports?.["./vite/cloudflare"], undefined);
  assert.equal(packageJson.exports?.["./vite/oauth-relay"], undefined);
